...
?>
	...
	<header class="cover cover-search">
		...
		<div class="cover-content wrapper">
			<h1 class="search-title"><?php esc_html_e('Search Result', 'manas'); ?></h1>
			...
			<span class="cover-article-count"><?php echo esc_html($wp_query->post_count); ?> <?php esc_html_e('Articles', 'manas'); ?></span>
		</div>
	</header>
